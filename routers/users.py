...
async def reset_password(
    ...
    if reset_token.expires_at < datetime.now(UTC):  #sqllite striped out tzinfo where as sqlalchemy includes this
...
async def delete_user(
    ...
    old_filename = user.image_file  #missed earlier
    ...
    # doAnotherThing()
    if old_filename:                              #missed earlier
...
async def upload_profile_picture(
    ...
    try:
        #new_filename = await run_in_threadpool(process_profile_image, content) #concurrency?
