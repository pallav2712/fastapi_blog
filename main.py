...
# of scope problems. Makes testing of a function difficult or impossible.
# This is working but avoid using it.
...
async def home(request: Request, db: Annotated[AsyncSession, Depends(get_db)]):
    result = await db.execute(
        select(models.Post).options(selectinload(models.Post.author)),  #lazy loading
    )
...
#dont use request library with async route because request lib is a sync dont mix
